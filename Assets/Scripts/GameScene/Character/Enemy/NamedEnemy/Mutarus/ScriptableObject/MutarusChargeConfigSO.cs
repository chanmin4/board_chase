...
[CreateAssetMenu(
    fileName = "MutarusChargeConfig",
    menuName = "ScriptableObject/GameScene/Enemy/Definition_Config/Mutarus Charge Config")]
public class MutarusChargeConfigSO : ScriptableObject
{
    [Header("Charge")]
    ...
    public float RotationSpeedDegPerSec => Mathf.Max(1f, _rotationSpeedDegPerSec);
}
