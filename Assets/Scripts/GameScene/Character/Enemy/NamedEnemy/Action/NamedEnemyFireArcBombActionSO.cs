...
[CreateAssetMenu(
    fileName = "NamedEnemyFireArcBombAction",
    menuName = "State Machines/Named Enemy Actions/Fire Arc Bomb")]
public class NamedEnemyFireArcBombActionSO : StateActionSO<NamedEnemyFireArcBombAction>
{
    [Header("Projectile")]
    ...
    public int ShotsPerCycle => _shotsPerCycle;
...
public class NamedEnemyFireArcBombAction : StateAction
{
    private NamedEnemyFireArcBombActionSO _config;
    ...
    {
        _config = (NamedEnemyFireArcBombActionSO)OriginSO;
