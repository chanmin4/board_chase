...
public class PlayerBulletLoadoutRuntime : MonoBehaviour
{
    ...
    public bool TryGetActivePrimaryBullet(out AttackBulletSO bullet)
    {
        bullet = GetActiveBullet(BulletAmmoType.AttackAndPaint) as AttackBulletSO;
        return bullet != null;
    }
    ...
    public bool TryConsumePrimaryAmmo(int amount, out AttackBulletSO bullet)
    {
        bullet = null;
