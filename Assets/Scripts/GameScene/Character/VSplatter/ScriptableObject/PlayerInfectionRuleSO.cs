...
public class PlayerInfectionRulesSO : ScriptableObject
{
    ...
    [Header("Poison Puddle Zone")]
    [Min(0f)]
    [SerializeField] private float poisonPuddleHealthDamagePerSecond = 5f;

    [Min(0f)]
    [SerializeField] private float poisonPuddleInfectionGainPerSecond = 12f;
    ...
    public float PoisonPuddleHealthDamagePerSecond => poisonPuddleHealthDamagePerSecond;
    public float PoisonPuddleInfectionGainPerSecond => poisonPuddleInfectionGainPerSecond;
}
