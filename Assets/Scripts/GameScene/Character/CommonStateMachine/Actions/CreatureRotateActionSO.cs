...
public class CreatureRotateActionSO : StateActionSO<CreatureRotateAction>
{
...
public class CreatureRotateAction : StateAction
{
    ...
    private CreatureRotateActionSO _originSO => (CreatureRotateActionSO)base.OriginSO;
